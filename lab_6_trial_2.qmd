...
# Calculate sum of squares for the ranks
...
# Calculate sum of products for the ranks
...
b <- 3.19
n <- length(hockey_data$Penalty_Minutes_Per_Game) # Number of observations

# Calculate the Residual Sum of Squares (RSS)
RSS <- SST - b * SP

# Calculate the Residual Mean Square (RMS or MSE)
RMS <- RSS / (n - 2)

# Print the Residual Mean Square
RMS
